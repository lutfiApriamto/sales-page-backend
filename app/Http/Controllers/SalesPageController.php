...
class SalesPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Meracik Prompt Khusus untuk Gemini (System Prompt)
        ...
        // Bagian menembak API Gemini di SalesPageController.php
$response = Http::withoutVerifying()
    ->withHeaders([
        'Content-Type' => 'application/json',
    ])
    // GANTI v1beta MENJADI v1 DI BAWAH INI:
    ...
    'detail_error_google' => $response->json(), // Ini akan nampilin alasan asli dari Google
